...
public class Wholesaler_View_Dairy_Orders extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wholesaler__view__dairy__orders);
        ...
        DairyRef = FirebaseDatabase.getInstance().getReference("WholesalerDairyOrders/"+ Id+"/Orders/" ) ;
