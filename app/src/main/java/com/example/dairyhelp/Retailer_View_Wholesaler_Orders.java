...
public class Retailer_View_Wholesaler_Orders extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_retailer__view__wholesaler__orders);
        ...
        DairyRef = FirebaseDatabase.getInstance().getReference("RetailerWholesalerOrders/"+ Id+"/Orders/" ) ;
