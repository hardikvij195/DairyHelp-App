...
public class Wholesaler_View_Retailer_Orders extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wholesaler__view__retailer__orders);
        ...
        DairyRef = FirebaseDatabase.getInstance().getReference("WholesalerRetailerOrders/"+ Id+"/Orders/" ) ;
        DairyRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()) {
                    ...
                    String DName = dataSnapshot1.child("Retailer").getValue().toString();
                    String OId = dataSnapshot1.child("Order Id").getValue().toString();

                    Orders.add(new OrderClass(Order , OId, "" , "Retailer Name : \n" + DName));
                    adap.notifyDataSetChanged();
