...
public class Admin_Create_Shop extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin__create__shop);
        ...
        Create_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if( !EmailOfUser.isEmpty() && !PassOfUser.isEmpty()&& !NameOfUser.isEmpty()&& !PhoneOfUser.isEmpty() && !Address.getText().toString().isEmpty()){
                    ...
                    mAuth.createUserWithEmailAndPassword(EmailOfUser,PassOfUser).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            if(task.isSuccessful()){
                                ...
                                useremail.sendEmailVerification().addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        ...
                                        if(task.isSuccessful()){
                                            ...
                                            Toast.makeText(Admin_Create_Shop.this, "Email Verification Sent" , Toast.LENGTH_SHORT).show();
                                            ...
                                            DairyRef = FirebaseDatabase.getInstance().getReference("Users/Shop/"+ UserUid) ;
                                            ...
                                            DairyRef = FirebaseDatabase.getInstance().getReference("Shop/"+ formattedDate) ;
                                            DairyRef.setValue(dataMap2);
                                            ...
                                            Toast.makeText(Admin_Create_Shop.this, "Email Does Not Exist" , Toast.LENGTH_SHORT).show();
                                ...
                                mAuth.signInWithEmailAndPassword(email ,pass).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                                    ...
                                    public void onComplete(@NonNull Task<AuthResult> task) {
                                        ...
                                        if(task.isSuccessful()){
                                            ...
                                            Toast.makeText(Admin_Create_Shop.this, "Account Successfully Created" , Toast.LENGTH_SHORT).show();
                                            mLoginProgress.dismiss();

                                        }else {


                                            Toast.makeText(Admin_Create_Shop.this, "Account Successfully Created Errorrr" , Toast.LENGTH_SHORT). show();
                                            mLoginProgress.dismiss();
                                ...
                                {
                                    Toast.makeText(Admin_Create_Shop.this, "Weak Password" ,
                                ...
                                {
                                    Toast.makeText(Admin_Create_Shop.this, "Malformed Email",
                                            Toast.LENGTH_SHORT).show();
                                    mLoginProgress.dismiss();
                                ...
                                {
                                    Toast.makeText(Admin_Create_Shop.this, "Email Already Exist" ,
                                            Toast.LENGTH_SHORT).show();
                                    mLoginProgress.dismiss();
                                ...
                                {
                                    Toast.makeText(Admin_Create_Shop.this,  e.getMessage() ,
                                            Toast.LENGTH_SHORT).show();
                                    mLoginProgress.dismiss();
                    ...
                    Toast.makeText(Admin_Create_Shop.this , "Every Field Needs To Be Filled" , Toast.LENGTH_SHORT).show();
                    mLoginProgress.dismiss();
                }
