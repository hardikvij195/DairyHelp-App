...
public class User_View_Orders extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user__view__orders);
        ...
        DairyRef = FirebaseDatabase.getInstance().getReference("UserShopOrders/"+ Id+"/Orders/" ) ;
