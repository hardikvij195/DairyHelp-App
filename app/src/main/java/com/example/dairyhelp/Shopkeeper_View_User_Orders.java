...
public class Shopkeeper_View_User_Orders extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shopkeeper__view__user__orders);
        ...
        DairyRef = FirebaseDatabase.getInstance().getReference("ShopUserOrders/"+ Id+"/Orders/" ) ;
